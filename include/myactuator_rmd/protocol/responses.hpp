 ...
 */
class GetCanIdResponse
    : public SingleMotorResponse<CommandType::CAN_ID_SETTING> {
 public:
   ...
   */
  [[nodiscard]] virtual std::uint16_t getCanId() const noexcept;
};
 ...
 */
class GetAccelerationResponse
    : public SingleMotorResponse<CommandType::READ_ACCELERATION> {
 public:
   ...
   */
  [[nodiscard]] std::int32_t getAcceleration() const noexcept;
};
 ...
 */
class GetMultiTurnAngleResponse
    : public SingleMotorResponse<CommandType::READ_MULTI_TURN_ANGLE> {
 public:
  GetMultiTurnAngleResponse() = delete;
  GetMultiTurnAngleResponse(GetMultiTurnAngleResponse const&) = default;
  GetMultiTurnAngleResponse& operator=(GetMultiTurnAngleResponse const&) =
      default;
...
class MultiTurnEncoderPositionResponse : public SingleMotorResponse<C> {
 public:
  ...
  MultiTurnEncoderPositionResponse(MultiTurnEncoderPositionResponse const&) =
      default;
  MultiTurnEncoderPositionResponse& operator=(
      MultiTurnEncoderPositionResponse const&) = default;
  MultiTurnEncoderPositionResponse(MultiTurnEncoderPositionResponse&&) =
      default;
  MultiTurnEncoderPositionResponse& operator=(
      MultiTurnEncoderPositionResponse&&) = default;
   ...
   */
  [[nodiscard]] std::int32_t getPosition() const noexcept;
};
...
using GetMultiTurnEncoderPositionResponse = MultiTurnEncoderPositionResponse<
    CommandType::READ_MULTI_TURN_ENCODER_POSITION>;
using GetMultiTurnEncoderOriginalPositionResponse =
    MultiTurnEncoderPositionResponse<
        CommandType::READ_MULTI_TURN_ENCODER_ORIGINAL_POSITION>;
using GetMultiTurnEncoderZeroOffsetResponse = MultiTurnEncoderPositionResponse<
 ...
 */
class GetSingleTurnAngleResponse
    : public SingleMotorResponse<CommandType::READ_SINGLE_TURN_ANGLE> {
 public:
  GetSingleTurnAngleResponse() = delete;
  GetSingleTurnAngleResponse(GetSingleTurnAngleResponse const&) = default;
  GetSingleTurnAngleResponse& operator=(GetSingleTurnAngleResponse const&) =
      default;
...
class GetSingleTurnEncoderPositionResponse
 ...
 public:
   ...
   *    The current encoder position
   */
  [[nodiscard]] std::int16_t getPosition() const noexcept;
   ...
   */
  [[nodiscard]] std::int16_t getRawPosition() const noexcept;
   ...
   */
  [[nodiscard]] std::int16_t getOffset() const noexcept;
};
...
class FeedbackResponse : public SingleMotorResponse<C> {
 public:
   ...
   */
  [[nodiscard]] Feedback getStatus() const noexcept;
};

template <CommandType C>
Feedback FeedbackResponse<C>::getStatus() const noexcept {
  auto const temperature{
      static_cast<int>(this->template getAs<std::int8_t>(1))};
  auto const current{static_cast<float>(this->template getAs<std::int16_t>(2)) *
                     0.01f};
  auto const shaft_speed{
      static_cast<float>(this->template getAs<std::int16_t>(4))};
  auto const shaft_angle{
      static_cast<float>(this->template getAs<std::int16_t>(6))};
  return Feedback{temperature, current, shaft_speed, shaft_angle};
}

using GetMotorStatus2Response =
    FeedbackResponse<CommandType::READ_MOTOR_STATUS_2>;
using SetPositionAbsoluteResponse =
    FeedbackResponse<CommandType::ABSOLUTE_POSITION_CLOSED_LOOP_CONTROL>;
using SetTorqueResponse =
    FeedbackResponse<CommandType::TORQUE_CLOSED_LOOP_CONTROL>;
using SetVelocityResponse =
    FeedbackResponse<CommandType::SPEED_CLOSED_LOOP_CONTROL>;
...
class GainsResponse : public SingleMotorResponse<C> {
 public:
   ...
   */
  [[nodiscard]] constexpr Gains getGains() const noexcept;
};
...
constexpr Gains GainsResponse<C>::getGains() const noexcept {
  ...
  return Gains{current_kp, current_ki,  speed_kp,
               speed_ki,   position_kp, position_ki};
}

using GetControllerGainsResponse =
    GainsResponse<CommandType::READ_PID_PARAMETERS>;
using SetControllerGainsPersistentlyResponse =
    GainsResponse<CommandType::WRITE_PID_PARAMETERS_TO_ROM>;
using SetControllerGainsResponse =
    GainsResponse<CommandType::WRITE_PID_PARAMETERS_TO_RAM>;
 ...
 */
class GetControlModeResponse
    : public SingleMotorResponse<CommandType::READ_SYSTEM_OPERATING_MODE> {
 public:
   ...
   */
  [[nodiscard]] constexpr ControlMode getMode() const noexcept;
};
 ...
 */
class GetMotorModelResponse
    : public SingleMotorResponse<CommandType::READ_MOTOR_MODEL> {
 public:
   ...
   */
  [[nodiscard]] std::string getModel() const noexcept;
};
 ...
 */
class GetMotorPowerResponse
    : public SingleMotorResponse<CommandType::READ_MOTOR_POWER> {
 public:
   ...
   */
  [[nodiscard]] float getPower() const noexcept;
};
...
class GetMotorStatus1Response
 ...
 public:
   ...
   */
  [[nodiscard]] MotorStatus1 getStatus() const noexcept;
};
 ...
 */
class GetMotorStatus3Response
    : public SingleMotorResponse<CommandType::READ_MOTOR_STATUS_3> {
 public:
   ...
   *    Motor status of the actuator
   */
  [[nodiscard]] MotorStatus3 getStatus() const noexcept;
};
 ...
 */
class GetSystemRuntimeResponse
    : public SingleMotorResponse<CommandType::READ_SYSTEM_RUNTIME> {
 public:
  GetSystemRuntimeResponse() = delete;
  GetSystemRuntimeResponse(GetSystemRuntimeResponse const&) = default;
  GetSystemRuntimeResponse& operator=(GetSystemRuntimeResponse const&) =
      default;
   ...
   */
  [[nodiscard]] std::chrono::milliseconds getRuntime() const noexcept;
};
...
using SetAccelerationResponse =
    SingleMotorResponse<CommandType::WRITE_ACCELERATION_TO_RAM_AND_ROM>;
using SetCanIdResponse = SingleMotorResponse<CommandType::CAN_ID_SETTING>;

/**\class SetCurrentPositionAsEncoderZeroResponse
 * \brief
 *    Response to request for setting the current position as the encoder zero
 * position
 */
class SetCurrentPositionAsEncoderZeroResponse
    : public SingleMotorResponse<
 ...
 public:
  ...
  SetCurrentPositionAsEncoderZeroResponse(
      SetCurrentPositionAsEncoderZeroResponse const&) = default;
  SetCurrentPositionAsEncoderZeroResponse& operator=(
      SetCurrentPositionAsEncoderZeroResponse const&) = default;
  SetCurrentPositionAsEncoderZeroResponse(
      SetCurrentPositionAsEncoderZeroResponse&&) = default;
  SetCurrentPositionAsEncoderZeroResponse& operator=(
      SetCurrentPositionAsEncoderZeroResponse&&) = default;
  using SingleMotorResponse::SingleMotorResponse;
   ...
   */
  [[nodiscard]] std::int32_t getEncoderZero() const noexcept;
};

using SetEncoderZeroResponse = SingleMotorRequest<
    CommandType::WRITE_ENCODER_MULTI_TURN_VALUE_TO_ROM_AS_ZERO>;
using SetTimeoutResponse = SingleMotorResponse<
