...
template <CommandType C>
constexpr SingleMotorMessage<C>::SingleMotorMessage(
...
template <CommandType C>
constexpr SingleMotorMessage<C>::SingleMotorMessage() noexcept : Message{} {
...
template <CommandType C>
constexpr SingleMotorRequest<C>::SingleMotorRequest(
    std::array<std::uint8_t, 8> const& data)
...
template <CommandType C>
constexpr SingleMotorResponse<C>::SingleMotorResponse(
    std::array<std::uint8_t, 8> const& data)
    : SingleMotorMessage<C>{data} {
  return;
}
