 ...
 *    In 2024 the actuators were re-branded, see
 * https://www.myactuator.com/downloads-x-series \author Tobit Flatscher
 * (github.com/2b-t)
 */
...
class X4V2 {
 public:
  ...
  static constexpr float torque_constant{
      rated_torque / rated_current};          // (manufacturer: 0.625) in Nm/A
...
class X4V3 {
 public:
  ...
  static constexpr float torque_constant{
      rated_torque / rated_current};  // (0.4, manufacturer: 0.35) in Nm/A
...
class X4_3 {
 public:
  ...
  static constexpr float torque_constant{rated_torque /
                                         rated_current};  // (0.75) in Nm/A
...
class X6V2 {
 public:
  ...
  static constexpr float torque_constant{
      rated_torque / rated_current};          // (manufacturer: 0.88) in Nm/A
...
class X6S2V2 {
 public:
  ...
  static constexpr float torque_constant{
      rated_torque / rated_current};          // (manufacturer: 6.92) in Nm/A
  static constexpr float rotor_inertia{800};  // in gcm2
  static constexpr std::int16_t number_of_pole_pairs{14};
};
...
class X6V3 {
 public:
  ...
  static constexpr float torque_constant{
      rated_torque / rated_current};  // (1.25, manufacturer: 0.17) in Nm/A
...
class X8V2 {
 public:
  ...
  static constexpr float torque_constant{
      rated_torque / rated_current};           // (manufacturer: 2.09) in Nm/A
...
class X8ProV2 {
 public:
  ...
  static constexpr float torque_constant{
      rated_torque / rated_current};           // (manufacturer: 2.6) in Nm/A
...
class X8S2V3 {
 public:
  ...
  static constexpr float torque_constant{
      rated_torque / rated_current};  // (7.81, manufacturer: 0.30) in Nm/A
...
class X8HV3 {
 public:
  ...
  static constexpr float speed_constant{33};  // in rpm/V
  static constexpr float torque_constant{
      rated_torque / rated_current};  // (1.71, manufacturer: 0.30) in Nm/A
  static constexpr float rotor_inertia{2670};  // in gcm2
};
...
class X8ProHV3 {
 public:
  ...
  static constexpr float speed_constant{30};   // in rpm/V
  static constexpr float torque_constant{
      rated_torque / rated_current};  // (2.13, manufacturer: 0.29) in Nm/A
  static constexpr float rotor_inertia{3400};  // in gcm2
};
...
class X10V3 {
 public:
  ...
  static constexpr float speed_constant{30};  // in rpm/V
  static constexpr float torque_constant{
      rated_torque / rated_current};  // (2.26, manufacturer: 0.32) in Nm/A
...
class X10S2V3 {
 public:
  ...
  static constexpr float speed_constant{30};  // in rpm/V
  static constexpr float torque_constant{
      rated_torque / rated_current};  // (7.46, manufacturer: 0.32) in Nm/A
  static constexpr float rotor_inertia{5675};  // in gcm2
};
