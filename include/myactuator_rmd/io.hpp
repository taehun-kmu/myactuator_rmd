...
inline std::ostream& operator<<(
    std::ostream& os, AccelerationType const& acceleration_type) noexcept {
  os << "0x" << std::hex << std::setfill('0') << std::setw(2)
     << static_cast<std::uint16_t>(acceleration_type) << std::dec;
...
inline std::ostream& operator<<(std::ostream& os,
                                CanBaudRate const& baud_rate) noexcept {
  os << "0x" << std::hex << std::setfill('0') << std::setw(2)
     << static_cast<std::uint16_t>(baud_rate) << std::dec;
  switch (baud_rate) {
...
inline std::ostream& operator<<(std::ostream& os,
                                ControlMode const& control_mode) noexcept {
  os << "0x" << std::hex << std::setfill('0') << std::setw(2)
     << static_cast<std::uint16_t>(control_mode) << std::dec;
  switch (control_mode) {
...
inline std::ostream& operator<<(std::ostream& os,
  ...
  os << "0x" << std::hex << std::setfill('0') << std::setw(4)
     << static_cast<std::uint16_t>(error_code) << std::dec;
  switch (error_code) {
    ...
    case ErrorCode::SPEEDING:
      os << " (speeding)";
      break;
    case ErrorCode::UNSPECIFIED_1:
    case ErrorCode::UNSPECIFIED_2:
    case ErrorCode::UNSPECIFIED_3:
...
inline std::ostream& operator<<(std::ostream& os, Gains const& g) noexcept {
  os << "current: {" << g.current << "}, speed: {" << g.speed
     << "}, position: {" << g.position << "}";
  return os;
}

inline std::ostream& operator<<(std::ostream& os,
                                MotorStatus1 const& motor_status) noexcept {
  os << "temperature: " << motor_status.temperature
     ...
     << ", error code: " << motor_status.error_code;
  return os;
}

inline std::ostream& operator<<(std::ostream& os,
                                MotorStatus2 const& motor_status) noexcept {
  os << "temperature: " << motor_status.temperature
     << ", current: " << motor_status.current
     << ", shaft speed: " << motor_status.shaft_speed
     << ", shaft angle: " << motor_status.shaft_angle;
  return os;
}

inline std::ostream& operator<<(std::ostream& os,
                                MotorStatus3 const& motor_status) noexcept {
  os << "temperature: " << motor_status.temperature
     << ", current phase A: " << std::boolalpha << motor_status.current_phase_a
     << ", current phase B: " << motor_status.current_phase_b
     << ", current phase C: " << motor_status.current_phase_c;
  return os;
}
