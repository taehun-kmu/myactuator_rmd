 ...
 * for more details Use derived exception classes if possible!
 */
...
/**\class BusOffError
 * \brief
 *    Exception class if the node is in bus off state (stops transmitting on the
 * network)
 */
...
/**\class BusError
 * \brief
 *    Exception class for general bus errors (e.g. faulty cables, noise,
 * incorrect termination, malfunctioning CAN nodes)
 */
